...
ApplePie.creator = document.getElementById('header').querySelector('p').innerHTML
var ingredientsList = document.getElementById('ingredient-list').querySelectorAll('li')
...
for (var i = 0, l = ApplePie.ingredients.length; i < l; i++) {
...
document.querySelector('img.pie').addEventListener('click', function hello(){
